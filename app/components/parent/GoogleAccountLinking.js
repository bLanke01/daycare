  ...
  return (
    <div className="google-linking-container">
      <div className="section-header">
        ...
        <p>Link your Google account for faster, easier sign-in to your daycare dashboard.</p>
      </div>
          ...
          <div className="linked-account">
            <div className="status-indicator linked">
              ...
              <div className="status-info">
                ...
                <p>You can sign in using either your email/password or Google account.</p>
              </div>
            </div>
          ...
          <div className="unlinked-account">
            <div className="status-indicator unlinked">
              ...
              <div className="status-info">
                ...
                <p>Link your Google account to enable one-click sign-in.</p>
              </div>
            </div>

            <div className="benefits-list">
              <h5>Benefits of linking your Google account:</h5>
              <ul>
                <li>✅ Faster sign-in - no need to remember passwords</li>
                <li>✅ More secure - Google handles authentication</li>
                <li>✅ Auto-sync profile picture from Google</li>
                <li>✅ Choice - use either email/password OR Google to sign in</li>
              </ul>
            </div>
